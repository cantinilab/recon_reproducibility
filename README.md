This repository contains the code to replicate the experiment of ReCoN's manuscript, accessible [here](https://www.biorxiv.org/content/10.64898/2026.01.20.700561v1).
...
The Jupyter Notebook reproduces the paper's main showcases, figures, and supplementary figures.
...
The code to obtain the receptor-gene links for both human and mouse. It relies on the ligand-receptor and ligand-target gene networks of [Nichenet]()https://www.nature.com/articles/s41592-019-0667-5, which can be [downloaded from Zenodo]().
...
⚠️ There is some stochasticity in HuMMuS inference, so the obtained network might slightly differ/ If you need the same GRNs as the ones used in the publication, please download them [here, on Zenodo]().
